...
final class TicketArchiveCommand extends BaseCommand
{
    ...
    {
        try {
            return $this->success($output, $this->service->archive($this->requireIntOption($input, 'ticket')));
        } catch (\Throwable $e) {
